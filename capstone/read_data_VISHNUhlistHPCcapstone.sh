...
for file in $(<datafile_list.txt)
  do
	...
	#gunzip -c /zpool0/fs2/shared/new_130_mpc_box/hires/5045/rockstar_halos/so_m200b/full_res/hlists/hlist_${var1}.dat.gz | \
	#2750000000 changed for 10^11.4 and 10^11.5  == 251188643151   & 316227766017
	gunzip -c /zpool0/fs2/shared/new_130_mpc_box/hires/5045/rockstar_halos/so_m200b/full_res/hlists/${file} | \
	   awk '(NR>=61 && $11 >= 100000000000 && $11 <= 1000000000000 && $6 == -1 ) {print $18 " " $19 " " $20}' \
	    > /scratch/chasonnscr/HOSTSpositdirHPC/PositionXYZdatafileHOSTS${var1}.dat 
